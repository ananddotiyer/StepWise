...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        DateTime? PreviousDblClick, CurrentDblClick; //nullable datetime
        long DblClickTime = 550;
        ...
        public string UpDown = "MouseDown"; //New
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0)) //&& (OnMouseActivity != null)
            {
                ...
                {
                    case WM_LBUTTONDOWN:
                        CurrentDblClick = DateTime.Now;
                        if ((CurrentDblClick.Value.Ticks - PreviousDblClick.Value.Ticks) < (10000 * DblClickTime))
                        {
                            //you've a double-click
                            wParam = WM_LBUTTONDBLCLK;
                        }
                        PreviousDblClick = CurrentDblClick;
                        UpDown = "MouseDown";
                        button = MouseButtons.Left;
                        RaiseMouseEvent(button, mouseHookStruct, wParam, mouseDelta);
                        break;
                    case WM_LBUTTONUP:
                        UpDown = "MouseUp";
                        button = MouseButtons.Left;
        ...
        private void RaiseMouseEvent(MouseButtons button, MouseLLHookStruct mouseHookStruct, int wParam, short mouseDelta)
        {
            int clickCount = 0;
